...
from .routes import agency, airtable, auth, autopilot, brain, brands, channels, competitors, film, growth, inbox, mail, misc, onboarding, pipeline, publishing, studio

ROUTERS = [agency, airtable, auth, autopilot, brain, brands, channels, competitors, control, film, growth, inbox, mail, memory,
